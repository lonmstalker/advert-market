...
public enum ErrorCode {
    ...
    TON_API_ERROR(502),
    TON_TX_FAILED(502),
    TON_INSUFFICIENT_GAS(422),
    WITHDRAWAL_VELOCITY_LIMIT_EXCEEDED(422),
    WITHDRAWAL_REQUIRES_MANUAL_REVIEW(422),
    ...
    WALLET_ADDRESS_REQUIRED(400),
    INVALID_TON_ADDRESS(400),
